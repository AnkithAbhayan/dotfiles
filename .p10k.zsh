# Generated by Powerlevel10k configuration wizard on 2024-08-31 at 14:25 IST.
...
typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#007399} %K{#003d51} %K{#001e29} %k'
typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#191919} %K{#323232} %K{#646464} %k'

#typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#191919} %K{#323232} %K{#646464} %k'
typeset -g POWERLEVEL9K_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#646464} %K{#323232} %K{#191919} %k'